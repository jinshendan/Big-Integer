...
void test_comparaison(){
	...
	x = "-123456789012345";
	y = "-123456789";
	cout << "Input: -123456789012345 > -123456789;  Output: ";
	cout << (x > y) << endl;
...
void test_minus(){
	...
	cout << "Input: 1000000000000000 - 200000000000000;   Output:   ";
	cout << x - y << endl;
	...
	cout << "Input: -1000000000000000000000000000000000000 - (-1000000000000000000000000000000000000);   Output:   ";
	cout << x - y << endl;
...
void test_multiply(){
	...
	cout << "Input: 12345678901234567890 * 22222222222223;   Output:   ";
	cout << x * y << endl;
